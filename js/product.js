...
const detail_tab_menu = document.querySelectorAll('.detail-tabs > a');
const detail_tab_contents = document.querySelector('.tab-content');
const detail_tab_content = document.querySelectorAll('.detail-content');
...
function switchTab(newTab) {
  ...
  detail_tab_menu.forEach(button => {
    button.classList.remove('active');
  });

  detail_tab_content.forEach(panel => {
